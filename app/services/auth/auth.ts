...
import {NavController,Storage, LocalStorage,Nav} from 'ionic-angular';
...
@ViewChild(Nav) nav: Nav;
  ...
  auth0 = new Auth0({clientID: 'rVlHppd17IcTpgeIuWWe35rXg9j0ci9K', domain: 'udit.auth0.com'});
  lock = new Auth0Lock('rVlHppd17IcTpgeIuWWe35rXg9j0ci9K', 'udit.auth0.com', {
    auth: {
      redirect: false,
      params: {
